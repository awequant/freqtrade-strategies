...
class ichiV1_Marius(IStrategy):
    ...
    ProfitMargin1 = DecimalParameter(
        0.009,
        0.019,
        default=sell_params["ProfitMargin1"],
        decimals=3,
        space="sell",
        optimize=True,
    )
    ProfitLoss1 = DecimalParameter(
        0.005,
        0.012,
        default=sell_params["ProfitLoss1"],
        decimals=3,
        space="sell",
        optimize=True,
    )
    ProfitMargin2 = DecimalParameter(
        0.033,
        0.099,
        default=sell_params["ProfitMargin2"],
        decimals=3,
        space="sell",
        optimize=True,
    )
    ProfitLoss2 = DecimalParameter(
        0.010,
        0.025,
        default=sell_params["ProfitLoss2"],
        decimals=3,
        space="sell",
        optimize=True,
    )
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        if current_profit > self.ProfitMargin2.value:
            ...
            sl_profit = self.ProfitLoss1.value + (
                (current_profit - self.ProfitMargin1.value)
    ...
    def informative_15m_indicators(
        ...
        informative_15m["max_flow_price"] = max_pump_detect_price_15m(
            informative_15m,
            period=self.pump_period.value,
            pause=self.pump_pause_duration.value,
        )
